...
model = Xception(include_top=True, weights=None, classes=8)
...
model.save(f'Xception_MeliponasImageDatastore227x227_ValAcc_{acc[-1]}.h5')
model.save_weights(f'Xception_MeliponasImageDatastore227x227_weights_ValAcc_{acc[-1]}.hdf5')
